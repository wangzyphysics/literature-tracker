...
title_zh: "密集联想记忆中的鞍形层次结构"
date: 2026-01-06
journal: "Machine Learning: Science and Technology"
authors: "Robin Thériault and Daniele Tantari"
link: "https://iopscience.iop.org/article/10.1088/2632-2153/ae3051"
---
...
- **作者**: Robin Thériault and Daniele Tantari
- **发表日期**: 2026-01-06
- **原文链接**: [https://iopscience.iop.org/article/10.1088/2632-2153/ae3051](https://iopscience.iop.org/article/10.1088/2632-2153/ae3051)
...
## 摘要（中文）
密集联想记忆（DAM）模型已经引起了新的关注，因为它们被证明对对抗性例子具有鲁棒性，并且与尖端机器学习范式密切相关，例如注意力机制和生成扩散。我们研究了一个基于三层玻尔兹曼机构建的 DAM，该机具有 Potts 隐藏单元，代表数据簇和类。通过统计力学分析，我们推导出鞍点方程，该方程描述了在真实数据上训练的 DAM 的驻点以及在师生框架内在合成数据上训练的 DAM 的不动点。基于这些结果，我们提出了一种新颖的正则化方案，使训练更加稳定。此外，我们凭经验证明我们的 DAM 可以学习监督和无监督分类问题的可解释解决方案。进一步推进我们的理论分析，我们发现相对较小的 DAM 学习到的权重对应于较大 DAM 中的不稳定鞍点。我们实现了一种网络增长算法，利用这种鞍点层次结构来大幅降低训练 DAM 的计算成本。
