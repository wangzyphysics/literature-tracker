...
authors: "未知"
link: "https://pubs.aip.org/aip/jcp/article/164/2/024112/3377246/Comparison-between-explicit-and-implicit"
---
...
- **作者**: 未知
- **发表日期**: 2026-01-13
- **原文链接**: [https://pubs.aip.org/aip/jcp/article/164/2/024112/3377246/Comparison-between-explicit-and-implicit](https://pubs.aip.org/aip/jcp/article/164/2/024112/3377246/Comparison-between-explicit-and-implicit)
...
## 摘要（中文）
我们通过比较基于显式波函数的离散化[通过多层多配置时间相关 Hartree (ML-MCTDH)] 和基于隐式密度矩阵的主方程方法[通过树张量网络分层运动方程 (TTN-HEOM)]，研究模拟与耗散浴耦合的开放量子系统的策略。对于以指数衰减浴相关函数为特征的耗散浴，HEOM 的隐式离散化方法（植根于浴相关函数分解）被证明比将浴显式离散为离散谐波模式更有效。 ML-MCTDH 等显式方法需要广泛的模式离散化来近似连续浴，从而导致计算瓶颈。两能级系统和 Fenna-Matthews-Olson 复杂模型的案例研究突显了 TTN-HEOM 在以最少数量的辅助模式捕获具有弛豫的耗散动力学方面的优越性，而显式方法与纯相移状态下的 HEOM 一样精确。这种比较是通过 TENSO 包实现的，该包使用相同的计算结构和传播策略实现了 ML-MCTDH 和 TTN-HEOM。
