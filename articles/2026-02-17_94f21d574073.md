...
title_zh: "基于伴随的形状优化、基于机器学习的代理模型、条件变分自动编码器 (CVAE)、福伊特施耐德推进 (VSP)、自航船、推进模型、船体优化"
date: 2026-02-17
...
## 中文标题
基于伴随的形状优化、基于机器学习的代理模型、条件变分自动编码器 (CVAE)、福伊特施耐德推进 (VSP)、自航船、推进模型、船体优化
