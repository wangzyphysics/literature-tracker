...
- [x] 5. 实现虚拟滚动
  - [x] 5.1 创建 VirtualScrollManager 类
    - 实现可见范围计算
    - 实现动态渲染
    - 添加缓冲区（10项）
...
- [x] 11. 实现研究主题演化分析
  - [x] 11.1 创建 TopicEvolutionAnalyzer 类
    - 创建时间切片
    - 提取每个时期的主题
